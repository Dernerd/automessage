...
function AM_transfer() {
	?>
	<div class="postbox ">
		<h3 class="hndle"><span><?php _e('Datenmigration','automessage'); ?></span></h3>
		<div class="inside">
			<?php
			if(AM_oldtablesexist()) {
				?>
				<p><?php _e('Du haat eine vorherige Installation von Automessage auf diesem Server, von der Du migrieren möchtest.','automessage'); ?></p>
				<p><?php _e('Klicke auf die Schaltfläche unten, um eine Migration zu starten. Dies könnte eine Weile dauern.','automessage'); ?></p>

				<?php
				if(!empty($_GET['migrate'])) {
					check_admin_referer('automessage_migrate');
					?>
					<p><strong><?php _e('Daten migrieren.','automessage'); ?></strong></p>
					<p><?php _e('Bitte warte, während wir Deine Daten migrieren.','automessage'); ?></p>
					<p><strong>1.</strong> <?php _e('Verschieben von Nachrichten auf Blog-Ebene...','automessage'); ?></p>
					<?php echo AM_movesitemessages(); ?>
					<p><strong>2.</strong> <?php _e('Verschieben von Nachrichten auf Benutzerebene...','automessage'); ?></p>
					<?php echo AM_moveusermessages(); ?>
					<p><strong><?php _e('Migration abgeschlossen.','automessage'); ?></strong></p>
					<?php
				} else {
					?>
				...
				?>
				<p>
					<?php _e('Du hast keine vorherige Installation von Automessage auf diesem Server, von der Du migrieren kannst.','automessage'); ?>
				</p>
				<?php
			}
			?>
